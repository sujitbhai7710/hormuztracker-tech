...
<div class="min-h-screen bg-slate-950">
  ...
  {:else if data}
    <!-- Header -->
    <div class="bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 border-b border-slate-800">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        <!-- Status Card -->
        <div class="bg-gradient-to-br from-slate-900 to-slate-900/80 border border-slate-800 rounded-xl p-6 glow-red">
        ...
        <!-- Duration Counter -->
        <div class="bg-gradient-to-br from-slate-900 to-slate-900/80 border border-slate-800 rounded-xl p-6 text-center">
        ...
        <!-- Crisis Severity -->
        <div class="bg-gradient-to-br from-slate-900 to-slate-900/80 border border-slate-800 rounded-xl p-6">
          ...
          <div class="text-center mt-2 text-xs text-red-400 font-semibold uppercase tracking-wider">Extreme Crisis</div>
        </div>
      </div>

      <!-- Key Metrics -->
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <div class="bg-gradient-to-br from-slate-900 to-slate-900/80 border border-slate-800 rounded-xl p-4 card-hover">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-gradient-to-br from-slate-900 to-slate-900/80 border border-slate-800 rounded-xl p-6">
          <div class="flex items-center justify-between mb-4">
            <h2 class="text-lg font-semibold text-white">Strait of Hormuz — Traffic Overview</h2>
            <a href="/map" class="text-xs text-red-400 hover:text-red-300 transition-colors">Full Map &rarr;</a>
          </div>
          <div class="relative">
            <svg viewBox="0 0 600 400" class="w-full h-auto" style="min-height: 300px;">
              ...
              {#each Array(Math.min(data.shipCount?.currentTransits || 2, 8)) as _, i}
        ...
        <div class="space-y-4">
          ...
          <div class="bg-gradient-to-br from-slate-900 to-slate-900/80 border border-slate-800 rounded-xl p-6">
            <div class="flex items-center justify-between mb-4">
              ...
              <a href="/news" class="text-xs text-red-400 hover:text-red-300 transition-colors">All News &rarr;</a>
            </div>
      ...
      <!-- Affected Regions -->
      <div class="bg-gradient-to-br from-slate-900 to-slate-900/80 border border-slate-800 rounded-xl p-6 mb-6">
        <div class="flex items-center justify-between mb-4">
          <h2 class="text-lg font-semibold text-white">Regional Impact</h2>
          <a href="/regions" class="text-xs text-red-400 hover:text-red-300 transition-colors">View All &rarr;</a>
        </div>
